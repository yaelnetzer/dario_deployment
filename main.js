...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_data_service__WEBPACK_IMPORTED_MODULE_8__["DataService"], _auth_service__WEBPACK_IMPORTED_MODULE_9__["AuthService"]],
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getUserActionList = function (params) {
...
module.exports = "<div class=\"container\">\n\t<h1 class=\"form-heading\">{{ pageHeader }}</h1>\n\n\t<button *ngIf=\"show\" type=\"submit\" class=\"btn btn-primary\" (click)=\"getUserActionList()\">Get List</button>\n\n\t\t<div class=\"form-group\">\n\t\t\t<ul class=\"list-group\" *ngFor=\"let listItem of userList\">\n\t\t\t\t<li class=\"list-group-item\">{{ listItem }}</li>\n\t\t\t</ul>\n\t\t</div>\n\n\t<button type=\"submit\" class=\"btn btn-primary\" (click)=\"logout()\">Logout</button>\n</div>\n"
...
var ListComponent = /** @class */ (function () {
    function ListComponent(_router, _data, _auth) {
        this._router = _router;
        this._data = _data;
        this._auth = _auth;
        this.pageHeader = "Hello!";
        this.show = true;
        this.userList = [];
    }
    ...
    ListComponent.prototype.getUserActionList = function () {
        var _this = this;
        this._data.getUserActionList(this._auth.userProfile).subscribe(function (data) {
            _this.userList = data;
            _this.show = false;
            _this.pageHeader = _this._auth.userProfile.given_name + ", here is your list:";
        }, function (err) { return console.error(err); }, function () { return console.log('done loading user actions list'); });
    };
    ListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])
    ], ListComponent);
...
module.exports = "<div class=\"container\">\n\n\t<h3>\n\t\t{{ loginTitle }}\n\t\t<small class=\"text-muted\">small and tight</small>\n\t</h3>\n\n\t<button type=\"submit\" class=\"btn btn-primary\" name=\"loginBtn\" (click)=\"login()\">{{ btnTxt }}</button>\n</div>"
...
module.exports = __webpack_require__(/*! C:\Users\migyagad\code_projects\dario\src\main.ts */"./src/main.ts");
